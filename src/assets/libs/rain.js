...
// Adjust number of raindrops based on screen size
...
for (let i = 0; i < numberOfRaindrops; i++) {
  ...
  // Adjust rain size and speed based on screen size
  if (window.innerWidth < 600) {
    randomRainHeight *= 0.5; // Smaller raindrops
    randomSpeed *= 0.5; // Slower raindrops
  }
...
window.addEventListener("resize", () => {
  ...
  // Adjust number of raindrops on resize
  rainArray = [];
